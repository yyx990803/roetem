...
module.exports = function buildClient (app, cb) {
  ...
  // create .roetem dir and public dir
  var roetemDir = cwd + '/.roetem'
  var pubDir = cwd + '/public'
  if (!fs.existsSync(roetemDir)) fs.mkdirSync(roetemDir)
